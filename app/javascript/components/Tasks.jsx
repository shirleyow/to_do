            ...
            {this.state.toggle ? (
              <div className="completed">
                ...
                <div className="current">
                  ...
                  { currentTasksLength == 0 ? (<div id = "pic"><img src={ require('../../assets/images/surprise.png') } /><p>Well done on completing all the tasks!<br></br>Go ahead and take a well-deserved break :)</p></div>) : "" }
                </div>
              )}
          </main>
        </div>
